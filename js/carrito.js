...
//FUNCION-evento vaciar carrito
botonesVaciar.addEventListener("click", alertaVaciarCarrito); //antes llamaba a vaciarCarrito aqui, pero es conveniente llamar a la alerta antes
...
function notificacionDeEliminar() {
